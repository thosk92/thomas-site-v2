  ...
  return (
    <section className="hero-initials" aria-label="Intro">
      ...
      <div ref={sigRef} className={`sig ${started ? "is-started" : ""}`} aria-hidden>
        <svg className="sig-svg" viewBox="0 0 1200 400">
          <text x="50%" y="28%" textAnchor="middle" className="sig-text">Thomas</text>
          <text x="50%" y="90%" textAnchor="middle" className="sig-text">Zanelli</text>
        </svg>
      </div>
